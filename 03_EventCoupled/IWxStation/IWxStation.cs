...
{
    // the delegates are declared in the interface namespace.
    // the events that the server makes public are declared in the interface.
    // the events are implemented in the class that implements the interface
