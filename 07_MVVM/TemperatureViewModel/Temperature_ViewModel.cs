...
namespace Temperature_ViewModel
{
    public class TemperatureViewModel : BindableBase
    {
        ...
        private Single m_temperature = -9999.0f;
        ...
        public TemperatureViewModel()
        {
            ...
            ((IWxStationExtended)m_station).ChangedTemperature += m_station_ChangedTemperature;
        ...
        public Single Temperature
        {
            ...
            set { SetProperty<Single>(ref m_temperature, value); OnPropertyChanged(() => Temperature); }
        }
